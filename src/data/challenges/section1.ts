  ...
  // Project 3: Learn Ownership by Building a Text Adventure
  {
    ...
    steps: [
      ...
      },
      {
        ...
        task: `Import the process module. If there are fewer than two user values, print a usage message and exit with a non-zero code. Then run the program with no extra arguments to see the usage.\n\n\`\`\`text\nUsage: text_adventure <name> <north|south|stay>\n\`\`\``,
        starterCode: `use std::env;\n\nfn main() {\n    println!("Rust Adventure");\n\n    let args: Vec<String> = env::args().collect();\n\n\n}`,
        highlightLine: 9,
        validation: {
          rules: [
